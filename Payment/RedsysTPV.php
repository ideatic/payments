...
class Payment_RedsysTPV extends Payment_Base
{
    ...
    public const PAYMENT_METHOD_GOOGLE_APPLE_PAY = 'xpay';
    ...
    /**
     * Parámetros adicionales para la autenticación EMV 3DS
     * @see https://pagosonline.redsys.es/parametros-entrada-salida.html
     * @var array{
     *    'acctID'?: string|null,
     * 'acctInfo'?: array{
     *     'chAccAgeInd'?: string,
     *     'chAccChange'?: string|null,
     *     'chAccChangeInd'?: string,
     *     'chAccDate'?: string|null,
     *     'chAccPwChange'?: string|null,
     *     'chAccPwChangeInd'?: string,
     *     'nbPurchaseAccount'?: int|null,
     *     'provisionAttemptsDay'?: int|null,
     *     'txnActivityDay'?: int|null,
     *     'txnActivityYear'?: int|null,
     *     'paymentAccAge'?: string|null,
     *     'paymentAccInd'?: string,
     *     'shipAddressUsage'?: string|null,
     *     'shipAddressUsageInd'?: string,
     *     'shipNameIndicator'?: string,
     *     'suspiciousAccActivity'?: string,
     *     },
     * 'addrMatch'?: string|null,
     ...
     * 'challengeWindowSize'?: string|null,
     * 'cres'?: string|null,
     * 'email'?: string|null,
     * 'homePhone'?: mixed,
     * 'merchantRiskIndicator'?: mixed,
     * 'mobilePhone'?: mixed,
     * 'notificationURL'?: string,
     * 'protocolVersion'?: string,
     * 'purchaseInstalData'?: string|null,
     ...
     * 'shipAddrPostCode'?: string|null,
     * 'shipAddrState'?: string|null,
     * 'threeDSCompInd'?: string,
     * 'threeDSInfo'?: string,
     * 'threeDSRequestorAuthenticationInfo'?: mixed,
     * 'threeDSServerTransID'?: string,
     * 'workPhone'?: mixed,
     * 'threeDSRequestorPriorAuthenticationInfo'?: mixed,
     * 'threeDSRequestorChallengeInd'?: string|null
     * }
     */
    public array $emv3DS = [];
    ...
    public function fields(): array
    {
        ...
        // Generar parámetros (https://pagosonline.redsys.es/parametros-entrada-salida.html)
        ...
        if (!empty($this->emv3DS)) {
            $redsys->setParameter('DS_MERCHANT_EMV3DS', json_encode($this->emv3DS, JSON_THROW_ON_ERROR));
        }
